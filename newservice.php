...
$status="";
$sql="SELECT * FROM service INNER JOIN signin ON service.uname=signin.uname WHERE service.status='".$status."'";
      ...
      <th>STATUS</th>
        <th>UPDATE</th>
  		...
  		while($row=mysqli_fetch_array($run)){
            ...
            echo '<form method=post action="viewnewservice.php">
                <input type=hidden name=sid value='.$row['sid'].'>
             <td><input type=submit name=testupdate value=viewdetails>
             </form>
             </td>';
            echo '</tr>';
